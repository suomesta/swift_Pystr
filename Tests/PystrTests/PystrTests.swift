...
final class PystrTests: XCTestCase {
    ...
    func test_splitlines() {
        ...
        XCTAssertEqual(["a", "bc"], "a\r\nbc".py.splitlines())
        XCTAssertEqual(["a", "", "bc"], "a\n\rbc".py.splitlines())
        XCTAssertEqual(["", "", "", ""], "\r\r\r\r".py.splitlines())
        XCTAssertEqual(["", "", "", ""], "\n\n\n\n".py.splitlines())
        XCTAssertEqual(["", ""], "\r\n\r\n".py.splitlines())
        XCTAssertEqual(["", "", "a", ""], "\r\ra\r\r".py.splitlines())
        XCTAssertEqual(["", "", "a", ""], "\n\na\n\n".py.splitlines())
        XCTAssertEqual(["", "a"], "\r\na\r\n".py.splitlines())
        XCTAssertEqual(["", "", "a", "bc"], "\r\ra\r\nbc\n".py.splitlines())
        XCTAssertEqual(["", "", "a", "bc"], "\n\na\r\nbc\r".py.splitlines())
        XCTAssertEqual(["", "a", "bc"], "\r\na\r\nbc\r\n".py.splitlines())
        ...
        XCTAssertEqual(["\r", "\r", "\r", "\r"], "\r\r\r\r".py.splitlines(true))
        XCTAssertEqual(["\n", "\n", "\n", "\n"], "\n\n\n\n".py.splitlines(true))
        XCTAssertEqual(["\r\n", "\r\n"], "\r\n\r\n".py.splitlines(true))
        XCTAssertEqual(["\r", "\r", "a\r", "\r"], "\r\ra\r\r".py.splitlines(true))
        XCTAssertEqual(["\n", "\n", "a\n", "\n"], "\n\na\n\n".py.splitlines(true))
        XCTAssertEqual(["\r\n", "a\r\n"], "\r\na\r\n".py.splitlines(true))
        XCTAssertEqual(["\r", "\r", "a\r\n", "bc\n"], "\r\ra\r\nbc\n".py.splitlines(true))
